...
PRODUCTS: dict[str, list[tuple[str, str, str, int, float, str, list[str]]]] = {
    ...
    "foregrip": [
        ("Magpul", "AFG-2 Angled Foregrip", "MAG-FG-AFG2", 2800, 3.5,
         "Angled foregrip for M-LOK handguards.",
         ["mount:m-lok", "style:angled"]),
        ("BCM", "Gunfighter Vertical Grip Mod 3", "BCM-FG-GF3", 3200, 3.8,
         "Short vertical foregrip for M-LOK handguards.",
         ["mount:m-lok", "style:vertical"]),
        ("Magpul", "RVG Rail Vertical Grip", "MAG-FG-RVG", 2600, 3.4,
         "Vertical foregrip with a textured surface for M-LOK handguards.",
         ["mount:m-lok", "style:vertical"]),
        ("Strike Industries", "Angled Grip", "SI-FG-ANG", 2200, 3.0,
         "Lightweight angled foregrip for M-LOK handguards.",
         ["mount:m-lok", "style:angled"]),
        ("B5 Systems", "Type 23 P.S.G.", "B5-FG-T23PSG", 3400, 3.6,
         "Pistol-grip-style foregrip for M-LOK handguards.",
         ["mount:m-lok", "style:pistol-grip-style"]),
        ("Grip Pod Systems", "GPS-BR Bipod Grip", "GPS-FG-BR", 8900, 12.0,
         "Foregrip with an integrated deployable bipod for M-LOK handguards.",
         ["mount:m-lok", "style:bipod"]),
    ],
}
