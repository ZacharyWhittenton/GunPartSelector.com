...
CATEGORIES = [
    ...
    ("buffer-tube", "Buffer Tube", "stock", 12),
    ("buffer-kit", "Buffer Kit", "stock", 13),
    ("optic", "Optic", "optics", 14),
    ("optic-mount", "Optic Mount", "optics", 15),
    ("muzzle-device", "Muzzle Device", "accessories", 16),
]
